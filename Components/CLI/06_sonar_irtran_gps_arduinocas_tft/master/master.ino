...
const char* ESP_PASS = WIFI_PASSWORD; // Your network pasword here
...
void setup()
{
    ...
    tft.print("Hello! You are Welcome to write to this cool display!");
    delay(250);
  ...
  if (cli.available())
  {
      ...
      */
      ...
      else if (cmd == lcd)
      {
          ...
          // convert the desired text from String to char array
          char user[] = "Gena";
          char char_arr[argVal_user_input.length()];
          argVal_user_input.toCharArray(char_arr, argVal_user_input.length());
