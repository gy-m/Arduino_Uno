        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /5/on") >= 0) {
              Serial.println("Sent message - to turn on ac");
              client.println("Hello, I am a new message");
              output5State = "ac on";
            }
            ...
            */
            ...
            // Display current state, and ON/OFF buttons for GPIO 5                 !!! display c (the message from the client) or send ACK
