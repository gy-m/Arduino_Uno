...
String get_client_data(WiFiClient client) {
    ...
    if (currentTime - previousTime <= timeoutTime) {
        ...
        //Serial.print("This is clients data when empty:");
        //Serial.print(client_http_data.length());
...
void send_data_to_arduino(String client_http_respond) {
  ...
  if(client_http_respond.length() == 1) {
    // empty client's data
    Serial.println("Client did not send any data from the browser");
  }
...
/*
   ...
   */
    ...
    client.println("<body onload=\"init_state()\">");
 ...
 /*
  ...
  <script>
      ...
      function init_state() {
        document.getElementById("TV_button").style.backgroundColor = "grey";
        document.getElementById("TV_status").innerHTML = "OFF";
        document.getElementById("AC_button").style.backgroundColor = "grey";
        document.getElementById("AC_status").innerHTML = "OFF";
        document.getElementById("IROBOT_button").style.backgroundColor = "grey";
        document.getElementById("IROBOT_status").innerHTML = "OFF";
      }
...
*/
  ...
  client.println("function init_state() {");
  //client.println("document.getElementById(\"TV_button\").style.backgroundColor = \"grey\";");
  //client.println("document.getElementById(\"TV_status\").innerHTML = \"OFF\";");
  //client.println("document.getElementById(\"AC_button\").style.backgroundColor = \"grey\";");
  //client.println("document.getElementById(\"AC_status\").innerHTML = \"OFF\";");
  //client.println("document.getElementById(\"IROBOT_button\").style.backgroundColor = \"grey\";");
  //client.println("document.getElementById(\"IROBOT_status\").innerHTML = \"OFF\";");
  client.println("}");
  ...
  client.println("}");
  client.println("xmlHttp.open(\"POST\", \"http://192.168.1.100\", true); // true for asynchronous");    // sending data to my self, because I want to esp get the state of the components from the post request (there is no other way to get it from the java script that runns in the client). Then show it in the serial Monitor
