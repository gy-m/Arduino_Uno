...
#define RAW_BUFFER_LENGTH  141  ///< Maximum length of raw duration buffer. Must be odd.
//#define RAW_BUFFER_LENGTH  69  ///< Maximum length of raw duration buffer. Must be odd.
#endif
